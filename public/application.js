...
/***/ function(module, exports, __webpack_require__) {
	...
	var pageEvents = __webpack_require__(7);
	var handlers = __webpack_require__(34);
	var blogEvents = __webpack_require__(39);
	var showNavbar = __webpack_require__(45);
	var showBlogStuff = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var emp = __webpack_require__(33);

	var onCreatePage = function onCreatePage(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createPage(data).then(function (response) {
	    store.page = response.page;
	    ui.onCreateSuccess(response.page);
	  }).catch(ui.onCreateError);
	};

	var onIndexPage = function onIndexPage(event) {
	  event.preventDefault();
	  var data = event;
	  api.indexPages(data).then(ui.indexPages).catch(ui.onShowError);
	};
	...
	var onShowPage = function onShowPage(event) {
	  ...
	  if (pageId.length === 0) {
	    ...
	    api.showPage(pageId).then(ui.showPage).catch(ui.onShowError);
	  }
	};

	var onShowSinglePage = function onShowSinglePage(event) {
	  event.preventDefault();
	  api.showPage($(this).data('id')).then(ui.singlePage).catch(ui.onShowError);
	};

	var onDeletePage = function onDeletePage(event) {
	  event.preventDefault();
	  api.destroyPage($(this).data('id')).then(ui.onDeleteSuccess()).catch(ui.onDeleteError);
	};
	...
	var onUpdatePage = function onUpdatePage(event) {
	  ...
	  if (emp.isBlank(info.page.body) || info.page.body.length === 1005) {
	    ...
	    api.updatePage(info, $(this).data('id')).then(ui.onUpdateSuccess).catch(ui.onUpdateError);
	  }
	};
	...
	module.exports = {
	  ...
	  onShowSinglePage: onShowSinglePage
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var destroyPage = function destroyPage(pageId) {
	  return $.ajax({
	...
	var updatePage = function updatePage(data, accountId) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showPageTemplate = __webpack_require__(11);
	// const showCommentsTemplate = require('../templates/comment-listing.handlebars');
	var showSinglePage = __webpack_require__(31);

	var indexPages = function indexPages(data) {
	  if (data.pages.length === 0) {
	    alertify.error("You don\'t have any pages!");
	  }
	  for (var i = 0; i < data.pages.length; i++) {
	    var content = data.pages[i].body;
	    data.pages[i].body = content.replace(/\n/g, '\n');
	    // console.log(typeof content);
	  }
	  var showPagesHtml = showPageTemplate({ pages: data.pages });
	...
	var singlePage = function singlePage(data) {
	  var showPagesHtml = showSinglePage({ page: data.page });
	  // selects the content element and appends new HTML into it
	  $('.kapat').modal('hide');
	  $('.log').html(showPagesHtml);
	};
	...
	var onCreateError = function onCreateError() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n   <div class=\"page-card card-1\" data-id=\""
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.footer : stack1), depth0))
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n                 <input type=\"text\" name=\"page[header]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.header : stack1), depth0))
	    + "\" class=\"clean-update\">\n                 <textarea type=\"text\" name=\"page[body]\" class=\"clean-update\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.body : stack1), depth0))
	    + "</textarea>\n                 <input type=\"text\" name=\"page[footer]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.footer : stack1), depth0))
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Remove</button>\n       <button type=\"button\" name=\"button\" class=\"btn btn-default shows-page\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Show</button>\n     </div>\n\n\n\n   </div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.pages : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"page-card card-1\">\n  <h3>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showBlogSignIn = __webpack_require__(37);
	var showBlogUI = __webpack_require__(38);
	var blogEvents = __webpack_require__(39);
	var pageEvents = __webpack_require__(7);
	var showPageStuff = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"signed-in-user-blog\">\n  <button type=\"button\" class=\"btn btn-default\" data-toggle=\"modal\" data-target=\"#blog-create\">\n        Create Blog\n      </button>\n  <!-- Modal -->\n  <div class=\"modal kapat\" id=\"blog-create\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n    <div class=\"modal-dialog\" role=\"document\">\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n          <h4 class=\"modal-title\" id=\"myModalLabel\">Create Blog</h4>\n        </div>\n        <div class=\"modal-body\">\n          <form class='create-blog'>\n            <input type=\"text\" name=\"blog[title]\" placeholder=\"Enter Title\">\n            <textarea type=\"text\" name=\"blog[content]\" placeholder=\"Enter Content for Body\" class=\"clean-update\"></textarea>\n            <input type=\"text\" name=\"blog[author]\" placeholder=\"Enter Author Name\">\n            <button type=\"submit\" class=\"btn btn-default\">Create Blog</button>\n          </form>\n        </div>\n      </div>\n    </div>\n  </div>\n\n\n  <!-- index blog -->\n  <button type=\"button\" class=\"btn btn-default sign-in-show\">View My Blogs</button>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<!-- index blog -->\n<button type=\"button\" class=\"btn btn-default homepage-blog-index\" id=\"blog-index\">View Blogs</button>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateBlog = function onCreateBlog(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createBlog(data).then(function (response) {
	    store.blog = response.blog;
	    ui.onPostSuccess(response.blog);
	  }).catch(ui.onCreateError);
	};

	var onIndexBlog = function onIndexBlog(event) {
	  event.preventDefault();
	  var data = event;
	  api.indexBlogs(data).then(ui.indexBlogs).catch(ui.onShowError());
	};

	var onIndexBlogSignedIn = function onIndexBlogSignedIn(event) {
	  event.preventDefault();
	  var data = event;
	  api.indexBlogsSignedIn(data).then(ui.indexBlogsSignedIn).catch(ui.onShowError);
	};
	...
	var onShowBlog = function onShowBlog(event) {
	  ...
	  if (blogId.length === 0) {
	    ...
	    api.showBlog(blogId).then(ui.showBlog).catch(ui.onShowError);
	  }
	};

	var onDeleteBlog = function onDeleteBlog(event) {
	  event.preventDefault();
	  api.destroyBlog($(this).data('id')).then(ui.onDeleteSuccess).catch(ui.onError);
	};
	...
	var onUpdateBlog = function onUpdateBlog(event) {
	  ...
	  if (emp.isBlank(info.blog.content) || info.blog.content.length === 1005) {
	    ...
	    api.updateBlog(info, $(this).data('id')).then(ui.onUpdateSuccess).catch(ui.onError);
	  }
	};
	...
	module.exports = {
	  ...
	  onIndexBlog: onIndexBlog,
	  onShowBlog: onShowBlog,
	  onDeleteBlog: onDeleteBlog,
	  addHandlers: addHandlers,
	  onIndexBlogSignedIn: onIndexBlogSignedIn
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexBlogsSignedIn = function indexBlogsSignedIn() {
	  return $.ajax({
	...
	var showBlog = function showBlog(id) {
	  return $.ajax({
	...
	module.exports = {
	  ...
	  indexBlogsSignedIn: indexBlogsSignedIn
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showBlogTemplate = __webpack_require__(42);
	var showBlogSignedIn = __webpack_require__(43);

	var indexBlogs = function indexBlogs(data) {
	  if (data.blogs.length === 0) {
	    alertify.error("There are no blogs!");
	  }
	  for (var i = 0; i < data.blogs.length; i++) {
	    var content = data.blogs[i].updatedAt;
	    data.blogs[i].updatedAt = content.split('T')[0];
	  }
	  var showBlogsHtml = showBlogTemplate({ blogs: data.blogs });
	  $('.log').html(showBlogsHtml);
	};

	var indexBlogsSignedIn = function indexBlogsSignedIn(data) {
	  if (data.blogs.length === 0) {
	  ...
	  var showBlogsHtml = showBlogSignedIn({ blogs: data.blogs });
	  $('.log').html(showBlogsHtml);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n\n   <div class=\"blog-card card-1\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n     <h3>"
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.blogs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n\n   <div class=\"blog-card card-1\" data-id=\""
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n         Update!\n       </button>\n       <button type=\"button\" name=\"button\" class=\"btn btn-default remove-blog\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Remove</button>\n     </div>\n\n     <footer>Author: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.author : stack1), depth0))
	    + "</footer>\n     <h5>Last Updated: "
	    ...
	    + "</h5>\n\n     <!-- Modal -->\n     <div class=\"modal kapat\" id=\"mod"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n       <div class=\"modal-dialog\" role=\"document\">\n         <div class=\"modal-content\">\n           <fieldset>\n             <legend>Update Blog</legend>\n             <form class=\"submit-blog-update\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n               <label class=\"need-space\">\n                 Title:\n                 <input type=\"text\" name=\"blog[title]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "\" class=\"clean-update\">\n               </label>\n               <label>\n                 Blog Content:\n                 <textarea type=\"text\" name=\"blog[content]\" class=\"clean-update\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "</textarea>\n               </label>\n               <label class=\"need-space\">\n                 Author:\n                 <input type=\"text\" name=\"blog[author]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.author : stack1), depth0))
	    + "\">\n               </label>\n               <button type=\"submit\" class=\"btn btn-default\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Submit</button>\n             </form>\n           </fieldset>\n           <div class=\"modal-footer\">\n             <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n           </div>\n         </div>\n       </div>\n     </div>\n   </div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<button type=\"button\" class=\"btn btn-default\" data-toggle=\"modal\" data-target=\"#create-page\">\n          Create Webpage\n        </button>\n<!-- Modal -->\n<div class=\"modal kapat\" id=\"create-page\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n  <div class=\"modal-dialog\" role=\"document\">\n    <div class=\"modal-content\">\n      <fieldset>\n        <legend>Create a Page</legend>\n        <form class='create-page'>\n          <label class=\"need-space\">\n            Header:\n            <input type=\"text\" name=\"page[header]\" placeholder=\"Enter Header\">\n          </label>\n          <label>\n            Page Body:\n            <textarea type=\"text\" name=\"page[body]\" placeholder=\"Enter Content for Body\" rows=\"10\" cols=\"50\"></textarea>\n          </label>\n          <label class=\"need-space\">\n            Footer:\n            <input type=\"text\" name=\"page[footer]\" placeholder=\"Enter Footer\">\n          </label>\n          <button type=\"submit\" class=\"btn btn-default create-webpage\">Create Webpage</button>\n        </form>\n      </fieldset>\n    </div>\n  </div>\n</div>\n\n<button type=\"button\" class=\"btn btn-default\" id=\"page-index\">View Pages</button>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<nav class=\"navbar navbar-inverse navbar-fixed-top\">\n  <div class=\"container\">\n    <div class=\"navbar-header\">\n      <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#navbar\" aria-expanded=\"false\" aria-controls=\"navbar\">\n                <span class=\"sr-only\">Toggle navigation</span>\n                <span class=\"icon-bar\"></span>\n                <span class=\"icon-bar\"></span>\n                <span class=\"icon-bar\"></span>\n              </button>\n      <a class=\"navbar-brand\">ScribbleBook</a>\n    </div>\n    <div id=\"navbar\" class=\"navbar-collapse collapse\">\n      <ul class=\"nav navbar-nav navbar-right\">\n        <li class=\"dropdown\">\n          <a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\">Menu <span class=\"caret\"></span></a>\n          <ul class=\"dropdown-menu\">\n            <li id=\"sign-up-dropdown\" data-toggle=\"modal\" data-target=\".sign-up-modal\"><a href=\"#\">Sign Up</a></li>\n            <li id=\"change-password-dropdown\" data-toggle=\"modal\" data-target=\".change-password-modal\"><a href=\"#\">Change Password</a></li>\n            <li role=\"separator\" class=\"divider\"></li>\n            <li class=\"dropdown-header\"></li>\n            <li id=\"exit\"><a href=\"#\">Sign Out</a></li>\n            <li id=\"sign-in-dropdown\" data-toggle=\"modal\" data-target=\".sign-in-modal\"><a href=\"#\">Sign In</a></li>\n          </ul>\n        </li>\n\n      </ul>\n    </div>\n    <!--/.nav-collapse -->\n  </div>\n</nav>\n\n<div class=\"top\">\n  <div class=\"authentication\">\n    <div class=\"modal fade sign-up-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myLargeModalLabel\">\n      <div class=\"modal-dialog modal-lg\" role=\"document\">\n        <div class=\"modal-content\">\n          <form id=\"sign-up\">\n            <fieldset>\n              <legend>Sign up!</legend>\n              <label>\n                        Email\n                        <input type=\"text\" name=\"credentials[email]\">\n                      </label>\n              <label>\n                        Password\n                        <input type=\"password\" name=\"credentials[password]\">\n                      </label>\n              <label>\n                        Password Confirmation\n                        <input type=\"password\" name=\"credentials[password_confirmation]\">\n                      </label>\n              <button type=\"submit\" class=\"btn btn-default\">Sign Up!</button>\n            </fieldset>\n          </form>\n          <div class=\"credential-status\"></div>\n        </div>\n      </div>\n    </div>\n\n    <div class=\"modal fade sign-in-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myLargeModalLabel\">\n      <div class=\"modal-dialog modal-lg\" role=\"document\">\n        <div class=\"modal-content\">\n          <form id=\"sign-in\">\n            <fieldset>\n              <legend>Sign in!</legend>\n              <label>\n                        Email\n                        <input type=\"text\" name=\"credentials[email]\">\n                      </label>\n              <label>\n                        Password\n                        <input type=\"password\" name=\"credentials[password]\">\n                      </label>\n              <button type=\"submit\" class=\"btn btn-default\">Sign In!</button>\n            </fieldset>\n          </form>\n          <div class=\"credential-status\"></div>\n        </div>\n      </div>\n    </div>\n\n    <div class=\"modal fade change-password-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myLargeModalLabel\">\n      <div class=\"modal-dialog modal-lg\" role=\"document\">\n        <div class=\"modal-content\">\n          <form id=\"change-password\">\n            <fieldset>\n              <legend>Change Password</legend>\n              <label>\n                        Old Password\n                        <input type=\"password\" name=\"passwords[old]\">\n                      </label>\n              <label>\n                        New Password\n                        <input type=\"password\" name=\"passwords[new]\">\n                      </label>\n              <button type=\"submit\" class=\"btn btn-default\">Change Password</button>\n            </fieldset>\n          </form>\n          <div class=\"credential-status\"></div>\n        </div>\n      </div>\n    </div>\n\n    <form id=\"sign-out\" class=\"hide\">\n      <fieldset>\n        <input type=\"submit\" name=\"submit\" value=\"Sign Out!\">\n      </fieldset>\n    </form>\n";
	},"useData":true});
